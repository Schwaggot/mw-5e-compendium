...
- [Operator Creation](#operator-creation)
    ...
    - [Personality Traits](#personality-traits-pick-one)
- [Operator Class](#operator)
    - [Class Features](#class-features)
    - [Basic Training](#basic-training)
    - [Second Wind, Operator Training, Action Surge, Extra Attack, Indomitable, Resourceful](#second-wind)
- [Combat Designations](#combat-designations)
    - [Rifleman](#rifleman)
    - [Machine Gunner](#machine-gunner)
    - [Marksman](#marksman)
    - [Demolitions Specialist](#demolitions-specialist)
...
- [Gear](#gear)
- [Homebrew Rules and Actions in Combat](#homebrew-rules-mods-and-actions-in-combat)
...
Your character's most basic strengths and weaknesses are defined by six "attributes" — Strength, Dexterity,
Constitution, Intelligence, Wisdom, and Charisma — each of which begins with a score of 8 to 18.

Your character's attribute scores begin at 8 each. You may spend 36 points to increase these scores, as shown in the
table below.

**Example:** Kevin uses his 36 points to purchase a Strength of 13 (6 points), a Dexterity of 15 (11 points), a
Constitution of 11 (3 points), an Intelligence of 12 (4 points), a Wisdom of 12 (4 points), and a Charisma of 14 (8
points).

Assign the highest scores to the attributes that represent your character's strengths and the lowest scores to the
attributes that represent his weaknesses. Keep in mind that certain attributes are more important than others for
certain classes, and that your Origin often adjusts one or more of them as well.
...
You rely on a broad array of tactics rather than a single approach. No matter what happens, you come up with a workable
solution — or at least a fair attempt.
...
You're smarter than most people, possibly because you were raised among academics or had the opportunity to indulge your
...
"Leap before you look" is your personal credo. Fortunately, you're usually fast enough or lucky enough to get away with
it. Usually.

- +2 Dexterity, -2 Intelligence.
- Gain a +5 to your Initiative.
...
- +1 bonus with melee attacks and damage rolls.
...
- +2 to any 1 attribute, -2 to any 1 attribute.
- Gain a +1 to all Skill checks made.
...
- Base AC increases by 1.
- Gain 1 additional Hit Point at each Level.
...
Operatives of Viper come from Special Forces units in all branches, due to their self-reliance and specialized
skill-set. Candidates also come from the other military branches and even the police force. Most candidates assigned to
the Operations, Communications and/or SIGINT squadrons go through an assessment and selection course, as well as a
lengthy background investigation and psychological testing. Once admitted to Viper Team, they receive further training
in specialized Training Courses. Like all units, this Intelligence Support Activity contains operational detachments as
well as support detachments such as intelligence analysis, medical, and logistics.

Candidates must have previous training in tactics, such as CQC, sniper, counter-sniper, and source development. Foreign
language skills, although highly desired, are not a prerequisite to becoming a member of Viper Team, though to be a
SIGINT/HUMINT operator in the field with other Special Mission Units, working clandestine operations in non-permissive
environments, knowing a minimum of several languages is usually indispensable (e.g. Persian, Arabic, Pashto, etc.).

Some of the disciplines focused on in the training course are: infiltration techniques, advanced air operations,
professional driving (offensive and off-road), personal defensive measures, state-of-the-art communications, deep
surveillance, tradecraft, weapons handling, hand-to-hand combat, and signals intelligence.
...
In your initial training during the Viper Team endoc you picked up on a few styles of combat. Pick one trait from below.
Gain one more trait at Levels 10 and 20. You may take the same style more than once.
...
Triage code Orange or better.

## Operator Training

At 2nd level, and again at 4th, 6th, 8th, 10th, 12th, 14th, 16th, 18th and 20th level, you pick 2 Levels in any Training
Program you choose. You may not use both levels on the same upgrade with a single use of Operator Training.
...
Re-roll a single skill check. Uses equal to your Intelligence modifier + Proficiency bonus.
...
Resistance to all damage except Chemical, Poison, and Radiation.
...
As an action with a SAW, GPM or Heavy Machine Gun, nominate a cube within the weapon's range. All targets in the cube
make a Dex save; fail = full damage, pass = half. Size and DC depend on distance. If you would have had disadvantage on
attack rolls this turn, enemies gain advantage on the save.
...
actually critical with this shot, you triple the damage dice.

### Stalker (7th)

When using a ghillie suit in appropriate environment, gain +10 to Stealth (instead of +5). Outside of 500 ft (instead of
1000 ft) you are considered invisible.

### One Shot One Kill (10th)

When dealing damage with a Critical Shot, the target may be forced into a Constitution save (DC = damage rolled). On
fail, reduced to 0 HP. On pass, damage is dealt normally. Uses equal to your Wisdom modifier per long rest.
...
Inspire a creature within 30 ft, giving it one Leadership Die. That creature can add the rolled number to one ability
check, attack roll, or saving throw within 10 minutes. Works like Bardic Inspiration.

### Seasoned Leader (10th)
...
**Fire on My Target.** When you take the attack action to make a ranged attack, pick willing creatures within 60 ft and
expend one Leadership Die per target. An equal number of friendly creatures within 60 ft and sight may use their
reaction to attack the same target; add a Leadership Die to the damage.

**Get Your Head Down.** Reaction when an ally within 5 ft is targeted by a ranged attack: expend one Leadership Die and
add it to the target's AC.

**Suppression.** When you take the Suppression action, expend Leadership Dice so an equal number of friendly creatures
use their reactions. You may suppress one extra target per character that joined.
...
**Reposition.** On your turn, pick willing targets within 60 ft and expend one die per target. They may disengage as a
bonus action. Lasts for a Leadership Die's worth of rounds.

**Take Cover.** On your turn, pick willing targets within 60 ft; expend one die per target. They gain +2 to all cover
bonuses. Lasts for a Leadership Die's worth of rounds.

**Go Silent.** Targets within 60 ft (one die each) gain +10 to Stealth. Lasts Leadership Die in minutes.

**Security.** Targets within 60 ft (one die each) gain advantage on attack rolls if they forgo movement for the turn.
Lasts Leadership Die in minutes.
...
only on targets at Triage Yellow, Orange, or Red). Increases to 2d10 at 10th, 3d10 at 20th.

### Medical Grade Supply (7th)

Trauma Bag gains a third part holding 10 uses of your choice of the following:

- **Combat Pill Pack:** 24 hours after consumption, gain advantage on all checks to resist disease or poison for 48
  hours.
- **Morphine:** Action; give to a creature within 5 ft or take yourself. Heals 6d6 HP on any triage code. Target must
  make a Con save (DC = HP restored) or fall unconscious, retesting each round. 3+ uses in 24 hours may cause addiction.
- **Quick Clot:** Stops Bleed or Major Bleed. Target makes Con save DC 15 or falls unconscious, retesting each turn.
- **Narcotics:** Action. Target regains 1d6 HP on use plus 1d6 for 3 additional rounds. Any triage code. 4+ uses in 24
  hours may cause addiction.
- **I.V. 500cc:** 1 minute to prep, up to 5 minutes to administer. Regain 1 HP every 2 rounds. Usable on Green, Yellow,
  Orange only.
- **Liquid Skin Patch:** Action; heal 2d6 HP. Usable only on Triage Orange and Red.
- **Epinephrine:** Action; on a creature reduced to 0 HP within the last 3 rounds, regain 6d4 HP. Usable only once per
  day safely — otherwise Con save (DC = HP gained), fail = unconscious for 10 rounds. 3+ uses/day = disadvantage on
  save; 4+ = target fails 3 death saves.
- **5 Days Diazepam:** After 5 consecutive days, each day's use lets you treat yourself as one Shaken level less than
  current, but not for healing purposes.

### Practical Applications (10th)

When healing via IFAK, Trauma Bag, or Medical Grade Supply, add your Proficiency bonus to the amount rolled. Also, you
may dash as a bonus action if you use your action to heal a target that turn.
...
If you have been with your dog more than a number of days equal to your level, the dog gains 2 traits from the list
below. 3 at 10th, 4 at 15th, 5 total at 18th. Some can be taken multiple times.
...
- **Defend Your Master:** Move up to half movement; must end within 5 ft of you. All enemy attacks on you this turn have
  disadvantage.
...
***Trained Tracker (Focus).*** Pick a Tracking Focus: **Drugs**, **Explosives**, or **Personnel**. +10 to any Skill
check to detect the focus. Passive Perception vs focus = 17.
...
Gain a B-1 Advanced Recon Drone (B1-RD) if you don't have one, and:

- Mark one target within 120 ft of the B1-RD; ranged attacks against it have advantage.
- +5 to Repair rolls for a B1-RD.

During a long rest, modify your drone with a Technology (Int) DC 15 check. Pass = one upgrade. Fail = no upgrade, retry
next rest. Critical fail = drone unusable until next long rest.
...
- **Pistol Mount:** Mount a pistol on the drone. If you moved no more than 60 ft, make 1 ranged attack using operator
  Dex + Proficiency.
...
- **3× Motion Sensors:** 2-inch, 4 mm thick discs that ping every 6 seconds when detecting movement within 20 ft. Bonus
  action to activate. Last 24 hours.
- **2× Seeker Grenades:** Sticky grenade requiring no attack so long as it can roll; moves 40 ft and self-detonates
  after 10 rounds.
- **5× Audio Bugs:** 1 cm microphones letting you hear within 20 ft. Bonus action to place. Last 8 hours.
...
With a Drone Repair Kit, create or maintain basic Tech devices in the field — audio bugs, basic comms, fixing a radio,
etc. (GM approval; Technology check, DC by GM). Your E B1-RD gains 1 permanent upgrade.
...
- **Level 1:** -4 per Burst/Controlled Burst.
- **Level 2:** -3 per Burst/Controlled Burst.
- **Level 3:** -2 per Burst/Controlled Burst.
- **Level 4:** -1 per Burst/Controlled Burst.
- **Level 5:** No negatives for Burst or Controlled Burst.

### Marksmanship Technique Training 1-4

- **Level 1:** At long range, count yourself as firing at 1 less range multiplier (min 1).
- **Level 2:** Aim as a bonus action.
- **Level 3:** Before a ranged attack with a proficient weapon, take -5 to attack; on hit, +10 to damage.
- **Level 4:** Count enemies as having one grade less of cover.

### Target Training 1-4

*Prereq: Marksman Level 2.*

- **Level 1:** Targeting a body part, reduce penalty by 1.
- **Level 2:** Add Proficiency bonus to any DC of your targeted shots.
- **Level 3:** Reduce body-part targeting penalty by an additional 1.
- **Level 4:** Targets have disadvantage on saves against your targeted shots.

### Close Quarters Marksmanship 1-4

- **Level 1:** +1 to attack rolls within one range increment.
- **Level 2:** +1 to damage rolls within one range increment.
- **Level 3:** +2 to attack rolls within one range increment.
- **Level 4:** +2 to damage rolls within one range increment.

### Long Range Marksmanship 1-4

- **Level 1:** +1 to attack rolls at greater than one range increment.
- **Level 2:** +1 to damage rolls at greater than one range increment.
- **Level 3:** +2 to attack rolls at greater than one range increment.
- **Level 4:** +2 to damage rolls at greater than one range increment.

### Guns Akimbo Training 1-4

*Prereq: Dexterity 16+.*

- **Level 1:** Offhand bonus-action attack with pistols that don't have Light.
- **Level 2:** +1 to attack and damage from either hand when wielding 2 ranged weapons.
- **Level 3:** Two basic attacks with your offhand as a bonus action.
- **Level 4:** Dual wield two-handed ranged weapons but fire at disadvantage.

### Ranged Weapon Training 1-5

*Each level may be taken once per Weapon Proficiency.*

- **Level 1:** Proficiency in one ranged or melee weapon group.
- **Level 2:** +1 to all attack rolls in that group.
- **Level 3:** +1 to all damage rolls in that group.
- **Level 4:** +1 to all attack rolls in that group.
- **Level 5:** +1 to all damage rolls in that group.
...
- **Level 4:** Advantage on attack rolls against grappled creatures. Action to pin (another grapple check). If
  successful both are restrained until grapple ends.
- **Level 5:** Unarmed strikes 1d8. If you have two free hands you may use 1d10.

### Advanced Unarmed Training 1-5

*Prereq: Unarmed Training Level 2.*

- **Level 1:** Gain Brawler Points equal to 2× your combined levels in Unarmed and Advanced Unarmed Training. Learn 3
  Brawler techniques.
- **Level 2:** Resistance to Bludgeoning/Subdual damage.
- **Level 3:** Creatures provoke opportunity attacks even when using Disengage.
- **Level 4:** Learn 3 more Brawler techniques.
- **Level 5:** On a hit with an opportunity attack, creature's speed becomes 0 for the rest of that turn.

### Brawler Points

Spend Brawler Points for techniques. Unavailable until a short or long rest is finished.

### Brawler Techniques

Brawler Technique Save DC = 8 + Proficiency Bonus + Dex or Strength modifier (your choice).

- **Double Strike:** After Attack action, spend 1 Brawler point for one unarmed strike, or 2 points for 2 unarmed
...
- **Disarming Strike:** 2 points on a melee attack. On hit, target takes normal damage; Str save or drop one held
  object.
...
- **Level 1:** Use a proficient ranged weapon as a blunt weapon (2H = 1d6, 1H = 1d4). With a bayonet, slashing or
  piercing instead.
- **Level 2:** One melee attack with a held ranged weapon as a bonus action.
- **Level 3:** 1H melee strikes become 1d6, 2H become 1d8.
- **Level 4:** Two melee attacks with a held ranged weapon as a bonus action.

### Dual Weapon Training 1-4

*Prereq: Dexterity 16+.*

- **Level 1:** Offhand bonus action attack with melee weapons that don't have Light.
- **Level 2:** +1 to attack and damage from either hand with 2 melee weapons.
- **Level 3:** Two basic offhand attacks as a bonus action.
- **Level 4:** Dual wield two-handed melee weapons but attack at disadvantage.
...
- **Level 2:** +1 to attacks in that group.
- **Level 3:** +1 to damage in that group.
- **Level 4:** +1 to attacks in that group.
- **Level 5:** +1 to damage in that group.

## Covert Training Programs

### Covert Movement Training 1-3

- **Level 1:** Proficiency in Stealth, or Expertise if already proficient.
- **Level 2:** Hide as a bonus action.
- **Level 3:** Hide when lightly obscured from the target.

### Covert Assault Training 1-6

- **Level 1:** Sneak Attack 2d6 (once per turn) with advantage on attack; alternately, ally within 5 ft of target.
  Finesse, unarmed, or ranged.
- **Level 2:** When hidden and you miss with a ranged attack, your position isn't revealed.
- **Level 3:** Sneak Attack increases to 4d6.
- **Level 4:** Advantage on attacks against creatures who haven't acted yet. Any hit vs a surprised creature is a
  critical.
...
- **Level 1:** Advantage on Stealth to set an ambush.
- **Level 2:** +2 to attacks during a Surprise round.
- **Level 3:** First hit during Surprise = critical; actual crit = triple damage dice.
- **Level 4:** During a surprise round, if any damage dice roll max, roll 1 extra die (no chain).

## Awareness Programs

### Awareness Training 1-4

- **Level 1:** Dim light doesn't impose disadvantage on Wis (Perception) checks relying on sight.
- **Level 2:** +5 passive perception.
- **Level 3:** Advantage on Wis (Perception) and Int (Investigation) vs secret doors and hidden caches.
- **Level 4:** +5 passive perception.

### Advanced Awareness Training 1-4

*Prereq: Awareness Training Level 2.*

- **Level 1:** Advantage on initiative rolls.
- **Level 2:** Fast travel doesn't impose the -5 penalty on passive Perception.
- **Level 3:** Can't be surprised while conscious.
- **Level 4:** If you can hear, you know the location of any hidden/invisible creature within 20 ft.

### Counter Ambush Training 1-4

- **Level 1:** Advantage on Wis (Perception)/Int (Investigation) vs traps or surprise attacks.
- **Level 2:** Fast travel doesn't impose the -5 penalty on passive Perception.
- **Level 3:** Resistance to damage dealt during a Surprise.
- **Level 4:** +5 AC vs attacks from unseen enemies.
...
Increase Dexterity by 1 per level.

### Fortitude Training 1-4

Increase Constitution by 1 per level.

### Physical Saves Training 1-4

*Each level once per save.*

- **Level 1:** Proficiency in Strength, Dexterity, or Constitution saves.
- **Level 2:** +1 to all those saves.
- **Level 3:** +1 to all those saves.
- **Level 4:** Advantage on all those saves.

### Physical Skills Training 1-5

*Each level once per skill.*

- **Level 1:** Proficiency in Athletics, Acrobatics, Sleight of Hand, or Stealth.
- **Level 2:** +1 to checks with that skill.
- **Level 3:** Ignore a critical failure in that skill (long rest).
- **Level 4:** +1 to checks.
- **Level 5:** Ignore a critical failure (short rest).

### Cardio Training 1-4

- **Level 1:** Proficiency in Athletics, or Expertise if already proficient.
- **Level 2:** +5 ft movement.
- **Level 3:** Dash as a bonus action.
- **Level 4:** +5 ft movement.

### Obstacle Course Trained 1-4

- **Level 1:** Climbing doesn't cost extra movement.
- **Level 2:** Standing from prone costs only 10 ft.
- **Level 3:** Running long/high jump after only 5 ft (instead of 10 ft).
- **Level 4:** +1d4 to all Acrobatics and Athletics checks.

### Resistance Training 1-6

- **Levels 1, 3, 5:** Resistance to one damage type.
- **Levels 2, 4, 6:** +1 HP per level.

## Mental Fitness Programs

### Education Training 1-4

Increase Intelligence by 1 per level.

### Resolve Training 1-4

Increase Wisdom by 1 per level.

### Social Training 1-4

Increase Charisma by 1 per level.

### Mental Saves Training 1-4

*Each level once per save.*

- **Level 1:** Proficiency in Intelligence, Wisdom, or Charisma saves.
- **Level 2:** +1 to those saves.
- **Level 3:** +1 to those saves.
- **Level 4:** Advantage on those saves.

### Mental Skills Training 1-5

*Each level once per skill.*

- **Level 1:** Proficiency in History, Investigation, Nature, Religion, Animal Handling, Insight, Medicine, Perception,
  Survival, Deception, Intimidation, Performance, or Persuasion.
- **Level 2:** +1 to checks.
- **Level 3:** Ignore a critical failure (long rest).
- **Level 4:** +1 to checks.
- **Level 5:** Ignore a critical failure (short rest).

### Language Training 1-5

*Each level once per language.*
...
- **Level 1:** Basic: pass a DC 10 check.
- **Level 2:** Moderate: DC 15.
- **Level 3:** Expert: DC 10 (the original text inverts the progression).
- **Level 4:** Master: no test needed.
- **Level 5:** Lip-read a known language.
...
*Note: the source text says Proficiency in Heavy armor at Level 1, which appears to be a typo.*
...
*Note: source text says Proficiency in Medium armor, another apparent typo.*

- **Level 1:** Proficiency in Heavy armor (source says Medium).
- **Level 2:** +1 DR for each piece of coverage.
- **Level 3:** Expertise in Strength saves.
- **Level 4:** +1 additional DR per piece of coverage.
...
- **Level 1:** Advantage on melee attacks if an ally is adjacent; advantage on CQC weapons if an ally is at a 90°
  offset.
- **Level 2:** Reaction melee/CQC attack when a creature within 5 ft attacks someone other than you.
- **Level 3:** Advantage on ranged attacks if an ally is at a 90° offset and within 30 ft.
- **Level 4:** Reaction ranged attack when a creature within 30 ft attacks someone other than you.

### Leadership Training 1-4

*Prereq: Charisma 13+.*

- **Level 1:** 10 mins briefing: up to 6 friendly creatures within 30 ft gain +Cha bonus to all skill checks for 24
  hours.
...
*(Listed in source but levels are blank.)*
...
- Action: spend one use of an IFAK to tend a wound within 5 ft. DC 15 Wis (Medicine); on pass restore 1d6 + Wis mod (
  Green, Yellow, Orange only). 2d6 at 7th, 3d6 at 14th, 4d6 at 20th.
...
Gain all benefits on taking Level 1.

**Level 1:**

- Proficiency with Mess Kit.
- During a short rest, cook food (with ingredients and Mess Kit) for creatures up to Wis bonus + Proficiency. Those who
  eat and spend Hit Dice regain an extra 1d4 HP per HD.
- In an hour or after a long rest, cook snacks = Proficiency + Wis mod. Last 12 hours. Bonus action to eat for Temp HP =
  Proficiency + Wis bonus.
...
|-----------------------------|--------------|--------|--------------|-------|--------|---------------------------------------------------------------------------------------|-----|
| Beretta 950 Jetfire         | .22 LR       | 1d4+2  | 1-2/20       | 10 ft | 0.3 kg | 1H, Lite, Covert, CQC, Recoil (7), Dependable, Inaccurate (-1), Reloading, Ammo 8     | 3   |
| Beretta 950 Jetfire         | .25 ACP      | 1d6    | 1-2/20       | 10 ft | 0.3 kg | 1H, Lite, Covert, CQC, Recoil (5), Dependable, Inaccurate (-1), Reloading, Ammo 8     | 3   |
| Colt Model 1908 Vest Pocket | .25 ACP      | 1d6    | 1/20         | 10 ft | 0.4 kg | 1H, Lite, CQC, Recoil (4), Inaccurate (-1), Reloading, Dependable, Ammo 6             | 3   |
| COP, Inc. COP               | .357 Magnum  | 3d4+1  | 1-2/19-20    | 10 ft | 0.8 kg | 1H, Lite, Covert, CQC, Recoil (20), Reloading, Ammo 4                                 | 5   |
...
| RSA Ots-21                  | 9×18 Makarov | 2d4    | 1-2/20       | 10 ft | 0.5 kg | 1H, Lite, Covert, CQC, Recoil (14), Inaccurate (-2), Reloading, Ammo 5                | 3   |
...
| Walther PP         | .380 ACP     | 1d8    | 1-2/20       | 20 ft | 0.7 kg | 1H, Lite, Covert, CQC, Recoil (11), Reloading, Ammo 8                         | 4   |
| Walther PPK        | .22 LR       | 1d4+2  | 1-2/20       | 10 ft | 0.6 kg | 1H, Lite, Covert, CQC, Recoil (3), Reloading                                  | 5   |
...
| Glock 17               | 9mm P       | 1d10+1 | 1/20         | 25 ft | 1H, CQC, Recoil (17), Reloading                             | 6   |
| Glock 17L              | 9mm P       | 1d10+1 | 1/20         | 35 ft | 1H, CQC, Recoil (16), Reloading                             | 9   |
| Glock 18               | 9mm P       | 1d10+1 | 1-3/20       | 25 ft | 1H, CQC, Recoil (16), Select Fire S/B/A, Reloading          | 10  |
| Glock 20               | 10mm ACP    | 2d6    | 1/19-20      | 25 ft | 1H, CQC, Recoil (18), Takedown, Reloading                   | 8   |
| Glock 21               | .45 ACP     | 1d12+1 | 1/19-20      | 25 ft | 1H, CQC, Recoil (16), Takedown, Reloading                   | 8   |
| Glock 22               | .40 S&W     | 1d12   | 1/20         | 25 ft | 1H, CQC, Recoil (18), Takedown, Reloading                   | 7   |
...
| SiG-Sauer P226         | 9mm P       | 1d10+1 | 1-2/20       | 25 ft | 1H, CQC, Recoil (16), Dependable, Reloading                 | 7   |
| SiG-Sauer P226         | .357 SiG    | 2d6+1  | 1-2/20       | 25 ft | 1H, CQC, Recoil (17), Dependable, Reloading                 | 7   |
| SiG-Sauer P226         | .40 S&W     | 1d12   | 1-2/20       | 25 ft | 1H, CQC, Recoil (15), Dependable, Takedown, Reloading       | 7   |
...
| Name                   | Caliber     | Damage | Misfire/Crit | Range | Properties                                            | Req |
|------------------------|-------------|--------|--------------|-------|-------------------------------------------------------|-----|
| Colt Detective Special | .38 Special | 1d8+1  | 1/20         | 15 ft | 1H, Lite, Covert, CQC, Recoil (15), Reloading, Ammo 6 | 3   |
| NAA Mini-Revolver      | .17 HMR     | 2d4+2  | 1/20         | 10 ft | 1H, Lite, Covert, CQC, Recoil (17), Reloading, Ammo 5 | 2   |
| NAA Mini-Revolver      | .22 LR      | 1d4+2  | 1/20         | 5 ft  | 1H, Lite, Covert, CQC, Recoil (13), Reloading, Ammo 5 | 2   |
| NAA Mini-Revolver      | .22 Magnum  | 2d4+2  | 1/20         | 10 ft | 1H, Lite, Covert, CQC, Recoil (17), Reloading, Ammo 5 | 2   |
| S&W Bodyguard          | .38 Special | 1d8+1  | 1/20         | 15 ft | 1H, Lite, Covert, CQC, Recoil (16), Reloading, Ammo 5 | 4   |
| S&W Chief's Special    | .38 Special | 1d8+1  | 1/20         | 15 ft | 1H, Lite, Covert, CQC, Recoil (13), Reloading, Ammo 5 | 4   |
| S&W Ladysmith          | .22 LR      | 1d4+2  | 1/20         | 10 ft | 1H, Light, Covert, CQC, Recoil (3), Reloading, Ammo 7 | 3   |
| S&W Ladysmith          | .38 Special | 1d8+1  | 1/20         | 15 ft | 1H, Lite, Covert, CQC, Recoil (13), Reloading, Ammo 5 | 3   |
| S&W Bodyguard          | .357 Magnum | 3d4+1  | 1/19-20      | 20 ft | 1H, Lite, Covert, CQC, Recoil (18), Reloading, Ammo 5 | 4   |
| S&W Ladysmith          | .357 Magnum | 3d4+1  | 1/19-20      | 15 ft | 1H, Lite, Covert, CQC, Recoil (18), Reloading, Ammo 5 | 3   |

## Service Revolvers

| Name                    | Caliber       | Damage | Misfire/Crit | Range | Properties                                                       | Req |
|-------------------------|---------------|--------|--------------|-------|------------------------------------------------------------------|-----|
| Colt Police Positive    | .22 LR        | 1d4+2  | 1/20         | 15 ft | 1H, CQC, Recoil (3), Reloading, Ammo 6                           | 4   |
| Colt Police Positive    | .32 S&W       | 1d4+2  | 1/20         | 15 ft | 1H, CQC, Recoil (3), Reloading, Ammo 6                           | 4   |
| Colt Police Positive    | .38 Special   | 1d8+1  | 1/20         | 20 ft | 1H, CQC, Recoil (14), Reloading, Ammo 6                          | 4   |
| Webley Mk. 6            | .455 British  | 1d8    | 1/20         | 20 ft | 1H, CQC, Recoil (5), Reloading, Ammo 6                           | 7   |
| Colt Single Action Army | .22 LR        | 1d4+2  | 1/20         | 15 ft | 1H, CQC, Recoil (2), Manual Action, Reloading, Ammo 6            | 14  |
| Colt SAA                | .357 Magnum   | 3d4+1  | 1/19-20      | 30 ft | Light, 1H, CQC, Recoil (18), Manual Action, Reloading, Ammo 6    | 14  |
...
| Colt Python             | .357 Magnum   | 3d4+1  | 1/19-20      | 30 ft | Light, 1H, CQC, Recoil (18), Dependable, Reloading, Ammo 6       | 7   |
| Manurhin MR-73          | .357 Magnum   | 3d4+1  | 1/19-20      | 30 ft | Light, 1H, CQC, Recoil (18), Dependable, Reloading, Ammo 6       | 6   |
| Manurhin MR-73          | 9mm P         | 1d10+1 | 1/20         | 25 ft | Light, 1H, CQC, Recoil (13), Dependable, Reloading, Ammo 6       | 6   |
| Taurus Model 608        | .357 Magnum   | 3d4+1  | 1/19-20      | 30 ft | 1H, CQC, Recoil (15), Reloading, Ammo 8                          | 5   |

## Hunting Revolvers

| Name                | Caliber     | Damage | Misfire/Crit | Range | Properties                                                    | Req |
|---------------------|-------------|--------|--------------|-------|---------------------------------------------------------------|-----|
| Ruger Super Redhawk | .44 Magnum  | 2d6+2  | 1/19-20      | 35 ft | 1H, CQC, Recoil (15), Dependable, Takedown, Reloading, Ammo 6 | 7   |
| Ruger Super Redhawk | .454 Casull | 3d6+1  | 1/19-20      | 45 ft | 1H, CQC, Recoil (15), Dependable, Takedown, Reloading, Ammo 6 | 9   |
| S&W Model 500       | .500 Magnum | 4d4+2  | 1/19-20      | 45 ft | 1H, CQC, Recoil (15), Takedown, Reloading, Ammo 5             | 10  |
| S&W Model 629       | .44 Magnum  | 2d6+2  | 1/19-20      | 35 ft | 1H, CQC, Recoil (15), Dependable, Takedown, Reloading, Ammo 6 | 8   |

## Semi-Auto Rifles

| Name            | Caliber        | Damage | Misfire/Crit | Range  | Properties                                                                 | Req |
|-----------------|----------------|--------|--------------|--------|----------------------------------------------------------------------------|-----|
| Ruger 10/22     | .22 LR         | 1d4+2  | 1-2/20       | 20 ft  | 2H, Recoil (1), Dependable, Reloading, Ammo 10                             | 3   |
| SVU-A           | 7.62×54R       | 1d8+2  | 1-2/19-20    | 75 ft  | 2H, Recoil (14), Accurate (1), Reloading, Ammo 10                          | 26  |
| Ruger Mini-14   | 5.56×45mm NATO | 4d4    | 1/20         | 125 ft | 2H, Recoil (13), Reloading, Ammo 30                                        | 5   |
| Ruger Mini-30   | 7.62×39mm      | 3d6    | 1/20         | 100 ft | 2H, Recoil (15), Reloading, Ammo 30                                        | 5   |
| H&K MSG-90      | 7.62×51mm NATO | 4d4+2  | 1-2/19-20    | 175 ft | 2H, Recoil (12), Accurate (2), Dependable, Reloading, Ammo 20              | 45  |
| Springfield M21 | 7.62×51mm NATO | 4d4+2  | 1-2/19-20    | 150 ft | 2H, Recoil (15), Accurate (2), Reloading, Ammo 20                          | 28  |
| MK 14 EBR       | 7.62×51mm NATO | 4d4+2  | 1/19-20      | 175 ft | 2H, Recoil (14), Dependable, Accurate (2), Reloading, Ammo 20              | 45  |
| H&K PSG-1       | 7.62×51mm NATO | 4d4+2  | 1-2/19-20    | 225 ft | 2H, Recoil (10), Accurate (3), Reloading, Ammo 5                           | 85  |
| KAC SR25        | 7.62×51mm NATO | 4d4+2  | 1-2/19-20    | 200 ft | 2H, Recoil (14), Accurate (2), Reloading, Ammo 20, **Integral Suppressor** | 28  |
| Barrett M82A1   | .50 BMG        | 2d12+2 | 1-2/18-20    | 350 ft | 2H, Recoil (17), Accurate (1), Takedown, Reloading, Ammo 5                 | 105 |
| NORINCO KBU-88  | 5.8×42mm       | 3d6    | 1-2/19-20    | 175 ft | 2H, Recoil (15), Accurate (1), Reloading, Ammo 10                          | 18  |
| Dragunov SVD    | 7.62×54R       | 2d10+1 | 1-2/19-20    | 200 ft | 2H, Recoil (17), Accurate (1), Reloading, Ammo 10                          | 19  |
| Simonov SKS     | 7.62×39mm      | 3d6    | 1/20         | 200 ft | 2H, Recoil (12), Dependable, Reloading, Ammo 10                            | 2   |
| M1 Garand       | .30-06         | 2d10+1 | 1-2/19-20    | 150 ft | 2H, Recoil (14), Dependable, Reloading, Ammo 8                             | 28  |

## Assault Rifles

| Name              | Caliber   | Damage | Misfire/Crit | Range  | Properties                                                                     | Mods                                                   | Req |
|-------------------|-----------|--------|--------------|--------|--------------------------------------------------------------------------------|--------------------------------------------------------|-----|
| Colt Commando     | 5.56 NATO | 4d4    | 1-4/20       | 50 ft  | 2H, Recoil (15), Reloading, Ammo 20                                            | Magazine, Sight                                        | 8   |
| Colt M16          | 5.56 NATO | 4d4    | 1-4/20       | 125 ft | 2H, Recoil (13), Reloading, Ammo 30                                            | Magazine, Sight                                        | 6   |
| Colt M16A1        | 5.56 NATO | 4d4    | 1-4/20       | 125 ft | 2H, Recoil (13), Reloading, Ammo 30                                            | Magazine, Sight                                        | 7   |
| Colt M16A2/A4     | 5.56 NATO | 4d4    | 1-3/20       | 125 ft | 2H, Recoil (10), Select Fire S/B, Reloading, Ammo 30                           | Compensator, Under Barrel, Magazine, Sight, Side Rails | 8   |
| Colt M16A3        | 5.56 NATO | 4d4    | 1-3/20       | 125 ft | 2H, Recoil (10), Reloading, Ammo 30                                            | Compensator, Under Barrel, Magazine, Sight, Side Rails | 8   |
| Colt M4           | 5.56 NATO | 4d4    | 1-3/20       | 100 ft | 2H, Recoil (12), Select Fire S/B, Reloading, Ammo 30                           | Full modification                                      | 7   |
| Colt M4A1         | 5.56 NATO | 4d4    | 1-3/20       | 100 ft | 2H, Recoil (12), Reloading, Ammo 30                                            | Full modification                                      | 8   |
| Colt M4 SOPMOD    | 5.56 NATO | 4d4    | 1-2/19-20    | 125 ft | 2H, Recoil (11), Accurate (2), Dependable, Select Fire S/B, Reloading, Ammo 30 | Full modification                                      | 45  |
| Enfield L85A1     | 5.56 NATO | 4d4    | 1-4/20       | 125 ft | 2H, Recoil (9), Reloading, Ammo 30                                             | -                                                      | 7   |
| Enfield L85A2     | 5.56 NATO | 4d4    | 1-3/20       | 125 ft | 2H, Recoil (9), Reloading, Ammo 30                                             | -                                                      | 8   |
| GIAT FAMAS F1     | 5.56 NATO | 4d4    | 1-3/20       | 125 ft | 2H, Recoil (11), Reloading, Ammo 25                                            | -                                                      | 8   |
| GIAT FAMAS G2     | 5.56 NATO | 4d4    | 1-3/20       | 125 ft | 2H, Recoil (10), Reloading, Ammo 30                                            | -                                                      | 9   |
...
| NORINCO QBZ-97    | 5.56 NATO | 4d4    | 1-3/20       | 125 ft | 2H, Recoil (12), Reloading, Ammo 30                                            | -                                                      | 9   |
| RSA AK-47         | 7.62×39mm | 3d6    | 1-2/20       | 125 ft | 2H, Recoil (11), Dependable, Reloading, Ammo 30                                | -                                                      | 5   |
| RSA AK-74         | 5.45×39mm | 2d8+1  | 1-2/20       | 125 ft | 2H, Recoil (10), Reloading, Ammo 30                                            | -                                                      | 5   |
| RSA AK-101        | 5.56 NATO | 4d4    | 1-3/20       | 125 ft | 2H, Recoil (12), Dependable, Reloading, Ammo 30                                | -                                                      | 6   |
| RSA AKS           | 7.62×39mm | 3d6    | 1-2/20       | 125 ft | 2H, Recoil (11), Reloading, Ammo 30                                            | -                                                      | 6   |
| RSA AKS-74        | 5.45×39mm | 2d8+1  | 1-2/20       | 125 ft | 2H, Recoil (10), Reloading, Ammo 30                                            | -                                                      | 5   |
| RSA AKS-74U       | 5.45×39mm | 2d8+1  | 1-3/20       | 125 ft | 2H, Recoil (12), Reloading, Ammo 30                                            | -                                                      | 8   |
| RSA AKS-74U-UBN   | 5.45×39mm | 2d8+1  | 1-3/20       | 125 ft | 2H, Recoil (10), Reloading, Ammo 30                                            | -                                                      | 21  |
...
| FN FAL            | 7.62 NATO | 4d4+2  | 1-3/19-20    | 175 ft | 2H, Recoil (17), Dependable, Reloading, Ammo 20                                | -                                                      | 9   |
| FN FAL Para       | 7.62 NATO | 4d4+2  | 1-3/19-20    | 160 ft | 2H, Recoil (18), Reloading, Ammo 20                                            | -                                                      | 9   |
| H&K G3A3/A4       | 7.62 NATO | 4d4+2  | 1-2/19-20    | 175 ft | 2H, Recoil (16-17), Reloading, Ammo 20                                         | -                                                      | 11  |
| H&K G3 SG/1       | 7.62 NATO | 4d4+2  | 1-2/19-20    | 175 ft | 2H, Recoil (17), Accurate (1), Reloading, Ammo 20                              | -                                                      | 8   |
| Springfield M14   | 7.62 NATO | 4d4+2  | 1-3/19-20    | 150 ft | 2H, Recoil (15), Dependable, Reloading, Ammo 20                                | -                                                      | 11  |

## Break-Action Shotguns

| Name                         | Gauge/Slug | Damage | Misfire/Crit | Range | Properties                                                         | Req |
|------------------------------|------------|--------|--------------|-------|--------------------------------------------------------------------|-----|
| Browning Superposed          | .410 slug  | 2d6+2  | 1/20         | 10 ft | 2H, Recoil (4), Takedown, Dependable, Imprecise, Reloading, Ammo 2 | 20  |
| Browning Superposed          | .410 shot  | 3d4+1  | 1/20         | 10 ft | same                                                               | 20  |
| Browning Superposed          | 20 ga slug | 2d8+2  | 1/19-20      | 20 ft | 2H, Recoil (12)                                                    | 10  |
| Browning Superposed          | 20 ga shot | 4d4+1  | 1/20         | 20 ft | 2H, Recoil (12)                                                    | 10  |
| Browning Superposed          | 12 ga slug | 2d12+2 | 1/19-20      | 30 ft | 2H, Recoil (17)                                                    | 12  |
| Browning Superposed          | 12 ga shot | 6d4+1  | 1/20         | 30 ft | 2H, Recoil (17)                                                    | 12  |
| Charles Daly Field II Hunter | .410 slug  | 2d6+2  | 1/20         | 10 ft | 2H, Recoil (4), Ammo 2                                             | 8   |
| Charles Daly Field II Hunter | .410 shot  | 3d4+1  | 1/20         | 10 ft | 2H, Recoil (4), Ammo 2                                             | 8   |
| Charles Daly Field II Hunter | 20 ga slug | 2d8+2  | 1/19-20      | 20 ft | 2H, Recoil (12), Ammo 2                                            | 8   |
| Charles Daly Field II Hunter | 20 ga shot | 4d4+1  | 1/20         | 20 ft | 2H, Recoil (12), Ammo 2                                            | 8   |
| Charles Daly Field II Hunter | 16 ga slug | 2d10+2 | 1/19-20      | 25 ft | 2H, Recoil (14), Ammo 2                                            | 9   |
| Charles Daly Field II Hunter | 16 ga shot | 5d4+1  | 1/20         | 25 ft | 2H, Recoil (14), Ammo 2                                            | 9   |
| Charles Daly Field II Hunter | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (17), Ammo 2                                            | 10  |
| Charles Daly Field II Hunter | 12 ga shot | 6d4+1  | 1/20         | 25 ft | 2H, Recoil (17), Ammo 2                                            | 10  |
| Charles Daly Field II Hunter | 10 ga slug | 3d10+2 | 1/18-20      | 30 ft | 2H, Recoil (19), Ammo 2                                            | 9   |
| Charles Daly Field II Hunter | 10 ga shot | 5d6+1  | 1/20         | 30 ft | 2H, Recoil (19), Ammo 2                                            | 9   |
| Savage Arms Model 24         | .410 slug  | 2d6+2  | 1/20         | 10 ft | Ammo 1                                                             | 6   |
| Savage Arms Model 24         | .410 shot  | 3d4+1  | 1/20         | 10 ft | Ammo 1                                                             | 6   |
| Savage Arms Model 24         | 20 ga slug | 2d8+2  | 1/19-20      | 20 ft | Ammo 1                                                             | 8   |
| Savage Arms Model 24         | 20 ga shot | 4d4+1  | 1/20         | 20 ft | Ammo 1                                                             | 8   |
| Savage Arms Model 24         | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | Ammo 1                                                             | 10  |
| Savage Arms Model 24         | 12 ga shot | 6d4+1  | 1/20         | 25 ft | Ammo 1                                                             | 10  |
| Winchester Model 21          | 20 ga slug | 2d8+2  | 1/19-20      | 20 ft | Ammo 2                                                             | 7   |
| Winchester Model 21          | 20 ga shot | 4d4+1  | 1/20         | 20 ft | Ammo 2                                                             | 7   |
| Winchester Model 21          | 16 ga slug | 2d10+2 | 1/19-20      | 25 ft | Ammo 2                                                             | 9   |
| Winchester Model 21          | 16 ga shot | 5d4+1  | 1/20         | 25 ft | Ammo 2                                                             | 9   |
| Winchester Model 21          | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | Ammo 2                                                             | 8   |
| Winchester Model 21          | 12 ga shot | 6d4+1  | 1/20         | 25 ft | Ammo 2                                                             | 8   |
...
| Remington 870         | 16 ga shot | 5d4+1  | 1/20         | 25 ft | same                                                                | 6   |
| Remington 870         | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (17), Ammo 4                                             | 8   |
| Remington 870         | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                                                | 8   |
| Remington 870P        | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (17), Ammo 7                                             | 7   |
| Remington 870P        | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                                                | 7   |
| Truvelo Neostead      | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (18), Takedown, Quirky, Ammo 12                          | 30  |
| Truvelo Neostead      | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                                                | 30  |
| Winchester Model 1897 | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (17), Takedown, Dependable, Ammo 6                       | 6   |
| Winchester Model 1897 | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                                                | 6   |
...
| Benelli M1 Tactical  | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                        | 8   |
| Benelli M4 Super 90  | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (16), Ammo 6                     | 14  |
| Benelli M4 Super 90  | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                        | 14  |
| Browning Auto-5      | 20 ga slug | 2d8+2  | 1/19-20      | 20 ft | 2H, Recoil (9), Ammo 5                      | 5   |
| Browning Auto-5      | 20 ga shot | 3d4+1  | 1/20         | 20 ft | same                                        | 5   |
| Browning Auto-5      | 16 ga slug | 2d10+2 | 1/19-20      | 20 ft | 2H, Recoil (10), Ammo 5                     | 7   |
| Browning Auto-5      | 16 ga shot | 5d4+1  | 1/20         | 20 ft | same                                        | 7   |
| Browning Auto-5      | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (17), Ammo 4                     | 9   |
| Browning Auto-5      | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                        | 9   |
| Daewoo USAS-12       | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (14), Ammo 10                    | 38  |
| Daewoo USAS-12       | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                        | 38  |
| Franchi SPAS-12      | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (17), Dependable, Ammo 8         | 10  |
| Franchi SPAS-12      | 12 ga shot | 6d4+1  | 1/20         | 25 ft | same                                        | 10  |
| Franchi SPAS-15      | 12 ga slug | 2d12+2 | 1/19-20      | 25 ft | 2H, Recoil (18), Ammo 6                     | 45  |
...
| AI AWM                      | 7mm Rem        | 2d8+2  | 1/19-20      | 225 ft | 2H, Recoil (15), Accurate (+1), Manual Action, Ammo 5           | 25  |
| AI AWM                      | .300 Win       | 3d6+2  | 1/19-20      | 225 ft | 2H, Recoil (15), Accurate (+1), Ammo 5                          | 27  |
| AI AWM                      | .338 Lapua     | 5d4    | 1/19-20      | 250 ft | 2H, Recoil (17), Accurate (+1), Ammo 4                          | 32  |
...
| Remington 700               | 7mm Rem        | 2d8+2  | 1/19-20      | 225 ft | 2H, Recoil (13), Ammo 3                                         | 9   |
| Remington 700               | 7.62 NATO      | 4d4+2  | 1/19-20      | 175 ft | 2H, Recoil (13), Ammo 4                                         | 11  |
| Remington 700               | .30-06         | 2d10+1 | 1/19-20      | 175 ft | 2H, Recoil (-), Ammo 4                                          | 13  |
| Remington 700               | .300 Win       | 3d6+2  | 1/19-20      | 125 ft | 2H, Recoil (15), Ammo 3                                         | 15  |
| Remington 700               | .375 H&H       | 5d4+1  | 1/19-20      | 225 ft | 2H, Recoil (16), Ammo 3                                         | 17  |
...
| Name               | Caliber      | Damage | Misfire/Crit | Range | Properties                                                     | Req |
|--------------------|--------------|--------|--------------|-------|----------------------------------------------------------------|-----|
| CZ Skorpion        | .32 ACP      | 1d6    | 1-3/20       | 20 ft | Lite, Covert, CQC, 1H, Recoil (5), Ammo 20                     | 9   |
| CZ Skorpion        | .380 ACP     | 1d8    | 1-3/20       | 20 ft | Lite, Covert, CQC, 1H, Recoil (8), Ammo 20                     | 11  |
| CZ Skorpion        | 9×18 Makarov | 2d4    | 1-3/20       | 25 ft | Lite, Covert, CQC, 1H, Recoil (8), Ammo 20                     | 13  |
| MAC M11            | .380 ACP     | 1d8    | 1-3/20       | 25 ft | Lite, CQC, 1H, Recoil (8), Imprecise, Select Fire B/A, Ammo 32 | 25  |
| H&K MP7A1          | 4.6×30mm     | 2d4+1  | 1-2/20       | 30 ft | Lite, CQC, 1H, Recoil (8), Ammo 20                             | 16  |
| IMI Micro-Uzi      | 9mm P        | 1d10+1 | 1-3/20       | 20 ft | Lite, CQC, 1H, Recoil (10), Ammo 20                            | 12  |
...
| H&K MP5K           | 9mm P        | 1d10+1 | 1-2/20       | 15 ft | Lite, CQC, 1H, Recoil (8), Ammo 15                             | 10  |
| H&K MP5K briefcase | 9mm P        | 1d10+1 | 1-3/20       | 15 ft | Lite, CQC, 1H, Recoil (4), Imprecise, Inaccurate (-4), Ammo 15 | 20  |
| Steyr TMP          | 9mm P        | 1d10+1 | 1-3/20       | 15 ft | Lite, CQC, 1H, Recoil (13), Ammo 15                            | 13  |

## Submachine Guns

| Name           | Caliber       | Damage | Misfire/Crit | Range | Properties                                         | Req |
|----------------|---------------|--------|--------------|-------|----------------------------------------------------|-----|
| IMI Uzi        | 9mm P         | 1d10+1 | 1-3/20       | 30 ft | 2H, CQC, Recoil (4), Ammo 32                       | 12  |
| IMI Mini-Uzi   | 9mm P         | 1d10+1 | 1-3/20       | 25 ft | 2H, CQC, Covert, Recoil (6), Ammo 32               | 13  |
| H&K MP5A4      | 9mm P         | 1d10+1 | 1-2/20       | 30 ft | 2H, CQC, Recoil (5), Ammo 30                       | 15  |
| H&K MP5A5      | 9mm P         | 1d10+1 | 1-2/20       | 30 ft | 2H, CQC, Recoil (5), Ammo 30                       | 16  |
| H&K MP5SD5     | 9mm P         | 1d10+1 | 1-2/20       | 30 ft | 2H, CQC, Recoil (6), Ammo 30                       | 19  |
| H&K MP5SD6     | 9mm P         | 1d10+1 | 1-2/20       | 30 ft | 2H, CQC, Recoil (5), Ammo 30                       | 20  |
| H&K MP5/40     | .40 S&W       | 1d12   | 1-2/20       | 30 ft | 2H, CQC, Recoil (6), Takedown, Ammo 30             | 18  |
| H&K MP5/10     | 10mm ACP      | 2d6    | 1-2/20       | 30 ft | 2H, CQC, Recoil (7), Ammo 30                       | 20  |
| H&K UMP        | 9mm P         | 1d10+1 | 1-2/20       | 30 ft | 2H, CQC, Recoil (7), Ammo 30                       | 8   |
| H&K UMP        | .40 S&W       | 1d12   | 1-2/20       | 30 ft | 2H, CQC, Recoil (8), Takedown, Ammo 30             | 10  |
| H&K UMP        | .45 ACP       | 1d12+1 | 1-2/20       | 30 ft | 2H, CQC, Recoil (9), Takedown, Ammo 30             | 12  |
| FN P90         | 5.7×28mm      | 1d10   | 1-3/20       | 35 ft | 2H, CQC, Recoil (5), Quirky, Ammo 50               | 17  |
| MP-40          | 9mm P         | 1d10+1 | 1-3/20       | 30 ft | 2H, CQC, Recoil (4), Ammo -                        | 10  |
| RSA Bizon-2    | 9×18 Improved | 1d10+2 | 1-3/20       | 35 ft | 2H, CQC, Recoil (7), Quirky, Ammo 66               | 14  |
| Sten Mk. II    | 9mm P         | 1d10+1 | 1-3/20       | 30 ft | 2H, CQC, Recoil (5), Dependable, Ammo 32           | 11  |
| Sten Mk. II(S) | 9mm P         | 1d10+1 | 1-3/20       | 30 ft | 2H, CQC, Recoil (5), Dependable, Ammo 32           | 16  |
...
| Name               | Caliber   | Damage | Misfire/Crit | Range  | Properties                                 | Req |
|--------------------|-----------|--------|--------------|--------|--------------------------------------------|-----|
| Enfield L86A1 LSW  | 5.56 NATO | 4d4    | 1-4/20       | 150 ft | 2H, Recoil (5), Ammo 30, Select Fire S/B/A | 48  |
| Browning M1918 BAR | .30-06    | 2d10+1 | 1-3/19-20    | 175 ft | 2H, Recoil (10), Dependable, Ammo 20       | 80  |
| FN Minimi (M249)   | 5.56 NATO | 4d4    | 1-3/20       | 175 ft | 2H, Recoil (5), Ammo 200                   | 40  |
| FN Minimi Para     | 5.56 NATO | 4d4    | 1-3/20       | 150 ft | 2H, Recoil (6), Ammo 200                   | 55  |
| NORINCO QJY-88     | 5.8×42mm  | 3d6+1  | 1-3/19-20    | 175 ft | 2H, Recoil (15), Ammo 200                  | 60  |
| RSA RPK            | 7.62×39mm | 3d6    | 1-3/20       | 150 ft | 2H, Recoil (10), Dependable, Ammo 40       | 32  |
| RSA RPK-74         | 5.45×39mm | 3d6+1  | 1-3/20       | 175 ft | 2H, Recoil (14), Dependable, Ammo 45       | 35  |
| Steyr AUG Hbar     | 5.56 NATO | 4d4    | 1-3/20       | 150 ft | 2H, Recoil (8), Ammo 30, Select Fire S/B/A | 39  |
...
| RSA PK        | 7.62×54R   | 2d10+1 | 1-3/19-20    | 200 ft | 2H, Recoil (10), Dependable, Ammo 100, Braced           | 19  |

## Heavy Machine Guns

| Name            | Caliber        | Damage | Misfire/Crit | Range  | Properties                                                         | Req |
|-----------------|----------------|--------|--------------|--------|--------------------------------------------------------------------|-----|
| Browning M2HB   | .50 BMG        | 2d12+2 | 1-3/18-20    | 300 ft | 2H, Recoil (6), Dependable, Imprecise, Takedown, Ammo 100, Mounted | 140 |
| GE M134 Minigun | 7.62 NATO      | 4d4+2  | 1-5/17-20    | 150 ft | 2H, Recoil (12), Imprecise, Inaccurate (-3), Ammo 100, Mounted     | 200 |
| RSA DShK        | 12.7×109mm     | 3d8+1  | 1-3/18-20    | 300 ft | 2H, Recoil (2), Imprecise, Takedown, Ammo 50, Mounted              | 110 |
| RSA KPV         | 14.5mm Russian | 3d10+1 | 1-3/18-20    | 350 ft | 2H, Recoil (4), Imprecise, Takedown, Ammo 40, Mounted              | 170 |

## Grenade Launchers

| Name               | Caliber | Misfire/Crit | Range  | Properties                                        | Req |
|--------------------|---------|--------------|--------|---------------------------------------------------|-----|
| RSA GP-25          | 40mm    | 1-4/See Ammo | 50 ft  | 2H, Recoil (8), Inaccurate (-5), Ammo 1           | 20  |
| Colt M203          | 40mm    | 1-2/See Ammo | 60 ft  | 2H, Recoil (8), Inaccurate (-5), Ammo 1           | 20  |
| Colt M203P         | 40mm    | 1-3/See Ammo | 60 ft  | 2H, Recoil (8), Inaccurate (-5), Ammo 1           | 20  |
| Colt M79 (Thumper) | 40mm    | 1-3/See Ammo | 50 ft  | 2H, Recoil (8), Inaccurate (-5), Ammo 1           | 20  |
| H&K AG36           | 40mm    | 1-3/See Ammo | 50 ft  | 2H, Recoil (8), Inaccurate (-5), Ammo 1           | 20  |
| Hawk MM-1          | 40mm    | 1-4/See Ammo | 50 ft  | 2H, Recoil (6), Inaccurate (-5), Ammo 12          | 20  |
| Milkor MGL Mk. 1   | 40mm    | 1-3/See Ammo | 40 ft  | 2H, Recoil (6), Inaccurate (-5), Ammo 6           | 40  |
| Saco Mk. 19        | 40mm    | 1-4/See Ammo | 300 ft | 2H, Recoil (7), Inaccurate (-5), Ammo 50, Mounted | 140 |

## Rocket Launchers

| Weapon          | Damage                     | Misfire/Crit | Range | Properties                                           | Req |
|-----------------|----------------------------|--------------|-------|------------------------------------------------------|-----|
| Talley M72 LAW  | 2d10 Force + 2d10 Piercing | 1-2/19-20    | 75 ft | 2H, Recoil (1), Inaccurate (-5), Blast 10 ft, Ammo 1 | 15  |
| Bofors AT4 HE   | 5d10 Force                 | 1-2/20       | 50 ft | 2H, Recoil (1), Inaccurate (-5), Blast 15 ft, Ammo 1 | 20  |
| Bofors AT4 HEAT | 2d10 Force + 3d10 Piercing | 1-2/20       | 50 ft | 2H, Recoil (1), Inaccurate (-5), Blast 10 ft, Ammo 1 | 20  |
...
| Name           | Damage                | Misfire/Crit | Range  | Weight | Properties                         | Req |
|----------------|-----------------------|--------------|--------|--------|------------------------------------|-----|
| 0.1 kg C4      | 2d10 Force per 0.1 kg | 1-2/20       | Placed | 0.1 kg | Blast 10 ft + 5 ft per 0.1 kg      | 5   |
| 1 ft Det Cord  | 2d10 Force per ft     | 1-2/20       | Placed | 0.1 kg | Blast 10 ft in line                | 5   |
| Sticky Grenade | 4d10 Force            | 1-3/20       | 30 ft  | 0.5 kg | 1H, Thrown, Deviation, Blast 15 ft | 6   |
...
| Helmet         | AC | Modifiers     | Resistances                            | Weight | Req |
|----------------|----|---------------|----------------------------------------|--------|-----|
...
| Name           | Benefit                              | Req |
|----------------|--------------------------------------|-----|
| Torso Plate    | 2 DR vs frontal torso attacks        | 10  |
| Shoulder Plate | 2 DR vs rear torso attacks           | 10  |
| Leg Plates     | 2 DR from both plates vs torso shots | 10  |
...
Each weapon can only install mods from its category.

## Common Mod Reference

The following appear across most categories and follow the same rules in each.
...
- **4× Scope/ACOG (Req 5):** Count range multiplier as 1 less (min 1).
- **4× Hybrid/RCO (Req 10):** 4× plus +1 within 1 range multiple.
- **6× Mid-Range (Req 15):** Range -1, +2 beyond first multiple, -2/-4 at closer ranges.
- **6× Hybrid (Req 20):** All of 6× plus +1 within 1 range multiple.
- **8× Long-Range (Req 15):** Range -2, +4 beyond first, -4/-8 at closer ranges.

### Magazines

- **Extended Magazine (Req 8):** +10 to +20 rounds (varies by weapon class).
...
- **Collapsible Stock (Req 5):** —
- **Buffer Group (Req 12):** Recoil reduced by 4.
- **Advanced Stock (Req 10):** +2 to damage rolls.
- **Auto Stock (Req 10):** Burst/auto negatives reduced by 1.
- **Quick Stock (Req 8):** +2 initiative when held at roll.

### Underbarrel

- **Grenade Launcher (Req 20):** Attach under-barrel grenade launcher (AR only).
- **Master Key (Req 16):** Attach under-barrel shotgun (AR only).
- **Fore Grip (Req 5):** +1 to single-shot attacks.
- **Pod Grip (Req 10):** +1 single-shot; Prone = range -1 and Braced.
- **Bipods (Req 10):** When prone/braced: range -1, Braced, burst/auto negatives -1, recoil -2.
- **Angled Fore Grip (Req 8):** +2 initiative when held.
- **Angled Short Grip (Req 12):** Burst/auto negatives -1.

### Trigger Housing

- **Comfort Grip (Req 8):** +2 initiative when held.
- **No Slip Grip (Req 5):** Advantage vs disarm/dropping.
- **Select Fire Single Shot (Req 5):** Can fire in single-shot mode.

### Side Rails

- **Flash Lite (Req 5):** Free-action flashlight (bright 50 ft, dim 100 ft).
- **Laser Sight (Req 8):** Free-action laser; +1 to hit within range. IR setting.
- **PEQ 16 (Req 15):** Flash Lite + Laser Sight combined.
- **Canted Iron Sights (Req 5):** Standard firing with long-range scopes attached.

### Barrel

- **Short Barrel (Req 12):** Range reduced by 1/4; +1 at 1 range multiple.
- **Long Barrel (Req 12):** Range increased by 1/4; -1 beyond 1 range multiple.
- **Precision Barrel (Req 15):** +1 to Critical range.
...
- **Shotgun:** Receiver, Sights (Dot, 4× Scope, 4× Hybrid), Magazines (ext +10, drum +30, quick), Muzzle (Compensator,
  Muzzle Break), Stocks, Underbarrel (Fore, Angled Fore), Trigger Housing (Comfort, No Slip), Side Rails, Barrel.
...
The B-1 Recon Drone (B1-RD or "bird") is a small man-portable 4-rotor drone weighing ~3.6 kg including its command
console. Deployed as an action. When operating, you command the drone via a 2-handed controller/screen. This uses your
full attention — you may not move, act, or react while piloting.

- Only passive skills apply during operation.
- Drone vision grants +5 Perception through the drone.
- DC 15 Dex (B1-RD tools) check to move the drone 60 ft; DC 20 for 120 ft dash. On fail, move half that turn (plus
...
- If destroyed and recovered: short rest + Drone Repair Kit + DC 15 Technology (Int) check (+1 per 20 ft fallen). Fail =
  one more attempt during a long rest at DC 20 + fall modifier. Second fail = unrepairable.

## Standard Gear Issue

Standard Viper-issued gear:
...
When attacking with a weapon that has the Automatic property, you may use Spray, Riddle, or Controlled Burst.

**Spray:** As an action, choose adjacent targets up to Dex modifier. Apply -5 per target beyond the first. Consumes
1d4+2 rounds per target (roll per attack). On a hit, score one extra hit per 5 whole points your attack exceeded AC (
max = rounds fired in the volley).

**Riddle:** As an action, choose volleys up to Dex modifier on a single target. Apply -5 per volley beyond first. Each
volley consumes 1d4+2 rounds. Extra-hit rule as above.

**Controlled Burst:** One burst per attack available. -5 per range multiple. Consumes 1d4+2 rounds. Extra-hit rule
applies.

## Burst Fire

For weapons with the burst property. One burst per attack. -5 per range multiple. Consumes 3 rounds. Extra-hit rule
applies.
...
As an action: 3 rounds, 1 volley of 1d4+2, or 1 burst per target. Target creatures within 10 ft of each other, up to Dex
modifier. Suppressed targets have disadvantage on ranged attacks and Wis (Perception) next turn. Cannot use with Manual
Action weapons.
...
**Shaken:** Stress damage condition with 5 levels.
...
A creature suffers all effects up to its current level. Stress damage heals over rest. See Damage Types.

**Triage Code:** All characters always have one triage code based on current HP.
...
- Each time total stress crosses a multiple of Wisdom score, target makes a Wisdom save. DC and condition depend on
  multiple reached.
...
A single shot, burst, or controlled burst may target a specific body part (declared before rolling). If not declared, it
is a torso shot.
