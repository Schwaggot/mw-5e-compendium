...
*Essential - choose one during [Character Creation](character-creation.md). Your background grants one Level 1
Training Program fixed by the choice, plus a small narrative feature.*

The narrative features below are written as soft guidance - the GM decides how they cash out in play. Multiple operators
at the same table may share a background.
...
- [Obstacle Course Training](training/physical-fitness-programs.md#obstacle-course-training-1-4) Level 1.
...
- [Physical Skills Training](training/physical-fitness-programs.md#physical-skills-training-1-5) Level 1 (Athletics).
...
- [Ordnance Training](training/tactical-programs.md#ordnance-training-1-4) Level 1.
...
- [Counter Ambush Training](training/awareness-programs.md#counter-ambush-training-1-4) Level 1.
...
- [Radio Operations Training](training/tactical-programs.md#radio-operations-training-1-4) Level 1.
- You identify drone models by sight or RF signature and are trained on jammers, net-gun systems, and directed-fire
  intercept doctrine.
...
- [Ordnance Training](training/tactical-programs.md#ordnance-training-1-4) Level 1.
- You identify commercial and military explosives by signature, and the GM may narrate the workings of an IED to you
  without a check.
...
- [Fortitude Training](training/physical-fitness-programs.md#fortitude-training-1-4) Level 1.
- You carry a passport of convenience and have a thick skin for abuse. Legionnaires recognize one another without a
  word.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Perception).
...
- [Weight Training](training/physical-fitness-programs.md#weight-training-1-4) Level 1.
...
- [Radio Operations Training](training/tactical-programs.md#radio-operations-training-1-4) Level 1.
- Trained to call and deconflict close air support, artillery, and naval fires. You know the brevity codes and
  risk-estimate procedures.
...
- [Unarmed Training](training/martial-weapon-programs.md#unarmed-training-1-5) Level 1.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Insight).
- You know arrest, detention, and chain-of-custody procedure, and can usually bluff your way through a friendly
  checkpoint.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Perception).
- Rated on military-class UAS. You are trained on the full targeting and ISR workflow, including sensor operation and
  strike deconfliction.

### Pararescue / CSAR

Combat search and rescue - you went in to bring people out.

- [Combat Life Savers Certified](training/tactical-programs.md#combat-life-savers-certified).
- Trained on hostile-environment extraction including helicopter hoist rescue. You are rated as a medical jumper and
  swimmer.
...
- [Social Training](training/mental-fitness-programs.md#social-training-1-4) Level 1.
- Trained in leaflet, broadcast, and social-media influence at operational level. You know how to shape a local
  population around a target or message.

### Scout Sniper

Two-man teams, range cards, and long waits.

- [Long Range Marksmanship](training/ranged-weapon-programs.md#long-range-marksmanship-1-4) Level 1.
...
- [Leadership Training](training/tactical-programs.md#leadership-training-1-4) Level 1.
...
- [Resolve Training](training/mental-fitness-programs.md#resolve-training-1-4) Level 1.
- Comfortable with long durations in confined quarters. You read a crew's rhythms and can tell when morale is about to
  crack.
...
- [Social Training](training/mental-fitness-programs.md#social-training-1-4) Level 1.
- Recognized by UN and NGO personnel in the field. You can request shelter, medical care, or a phone at any UN or
  recognized NGO compound.
...
- [Advanced Awareness Training](training/awareness-programs.md#advanced-awareness-training-1-4) Level 1.
- You keep informal ties in the analytical cells. Once per mission, a former colleague will read you a short
  pattern-of-life summary on a named individual or location over the phone.

### Cyber Operator

Network implants, endpoint compromise, and a laptop bag that never leaves your side.

- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Technology).
- You recognize common OS and network fingerprints, identify obvious malware families at a glance, and can usually
  bluff basic sysadmin or help-desk roles to get physical or network access.
...
- [Social Training](training/mental-fitness-programs.md#social-training-1-4) Level 1.
- You maintain a complete legend (papers, address, employment history, banking) in one country of your choice. It holds
  up to a routine police check.
...
- [Social Training](training/mental-fitness-programs.md#social-training-1-4) Level 1.
- You build and run a persona at scale on social platforms, and can recognize an ongoing influence campaign from the
  outside.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Perception).
- You identify vehicle types, unit sizes, and construction use from satellite or drone imagery, and can read a contour
  map at speed.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Investigation).
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Insight).
- When questioning a subject under interview conditions, you spot lies on a passive check. Trained on detention
  procedure and EPW handling.

### OSINT Analyst

Open-source work - databases, social media, and a patient browser.

- [Education Training](training/mental-fitness-programs.md#education-training-1-4) Level 1.
- Given a few hours and an internet connection, you can build a usable dossier on any public figure without tipping
  them off.
...
- [Radio Operations Training](training/tactical-programs.md#radio-operations-training-1-4) Level 1.
- You recognize traffic patterns and encryption styles, can usually identify the service branch behind a transmission,
  and are familiar with direction finding.

### Surveillance Operator (Watcher)

Two cars, three foot teams, and a comms net.

- [Covert Movement Training](training/covert-programs.md#covert-movement-training-1-3) Level 1.
- You shadow a target through an urban environment without being made, and can spot a surveillance team tailing someone
  else.
...
- [Physical Skills Training](training/physical-fitness-programs.md#physical-skills-training-1-5) Level 1 (Sleight of
  Hand).
- You plant and retrieve covert recording devices in occupied spaces and are familiar with common commercial lock
  types.
...
- [Education Training](training/mental-fitness-programs.md#education-training-1-4) Level 1.
- You attribute an intrusion to a likely threat actor from observed tradecraft, and maintain a personal source list in
  the threat-research community.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Investigation).
- You coordinate with ISPs, payment providers, and exchanges under subpoena, and are familiar with crypto tracing and
  dark-market takedowns.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Intimidation).
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Investigation).
- You read and preserve a crime scene without contaminating it, and know what will and will not hold up in evidentiary
  procedure.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Insight).
- You have one ex-partner still on the job in your home city, and you know that city's criminal geography block by
  block.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Animal Handling).
- Trained on patrol and detection dogs. You know the K-9 deployment workflow and can read what a working dog is telling
...
- [Close Quarters Battle (CQB) Training](training/martial-weapon-programs.md#close-quarters-battle-cqb-training-1-4)
  Level 1.
...
- [Physical Skills Training](training/physical-fitness-programs.md#physical-skills-training-1-5) Level 1 (Survival).
- You know reserve patrol routines and poacher TTPs. Inside a recognized park or reserve, your authority is respected
...
- [Education Training](training/mental-fitness-programs.md#education-training-1-4) Level 1.
- Pick a field (history, engineering, linguistics, biology, and so on). You are treated as an expert in that field by
  peers and laypeople alike.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Nature).
...
- [Education Training](training/mental-fitness-programs.md#education-training-1-4) Level 1.
- Rated on commercial drone classes. You can plan and fly autonomous survey missions and produce usable mapping
  output.
...
- [Field Mess](training/tactical-programs.md#field-mess).
- A hot meal you prepare at a halt visibly lifts morale. The GM may grant narrative dividends (looser tongues, better
...
- [Resolve Training](training/mental-fitness-programs.md#resolve-training-1-4) Level 1.
- You know high-control-group manipulation from the inside. You recognize coercive tactics used against yourself or
  others without a check.
...
- [Social Training](training/mental-fitness-programs.md#social-training-1-4) Level 1.
- You can approach and calm almost any domestic animal. Through your clients you know whose dog lives where in a
  chosen neighborhood.
...
- [Physical Skills Training](training/physical-fitness-programs.md#physical-skills-training-1-5) Level 1 (Technology).
- You field-repair downed drones from scrap, and can modify a commercial drone to carry a small payload or extend its
  range.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Animal Handling).
- You handle trained raptors. With time and line of sight, your bird can scout a rooftop or strike a small target on
  cue.
...
- [Resistance Training](training/physical-fitness-programs.md#resistance-training-1-6) Level 1 (fire and smoke).
...
- [Agility Training](training/physical-fitness-programs.md#agility-training-1-4) Level 1.
...
- [Physical Skills Training](training/physical-fitness-programs.md#physical-skills-training-1-5) Level 1 (Technology).
- You fabricate and modify firearms. You identify any firearm's provenance from proof marks and serials without a
  check.
...
- [Education Training](training/mental-fitness-programs.md#education-training-1-4) Level 1.
- You read a plant's process diagram and identify its attack surface. You understand that crashing a PLC can crash a
  boiler.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Investigation).
- You reconstruct an intrusion from logs and disk images, and preserve chain of custody for digital evidence that will
  hold up in court.
...
- [Thrown Training](training/tactical-programs.md#thrown-training-1-4) Level 1.
...
- [Language Training](training/mental-fitness-programs.md#language-training-1-5) Level 1 (a language of your choice).
- You pick up functional survival-level conversation in any new language after a week of exposure. Credentialed for
  court or diplomatic translation in at least one language pair.
...
- [Covert Movement Training](training/covert-programs.md#covert-movement-training-1-3) Level 1.
- Given thirty minutes and a working kit, you can disguise yourself or an ally well enough to pass casual inspection at
...
- [Physical Skills Training](training/physical-fitness-programs.md#physical-skills-training-1-5) Level 1 (tool-flavored
...
- [Awareness Training](training/awareness-programs.md#awareness-training-1-4) Level 1.
- You know the rhythm of empty buildings after hours. You still have a ring of keys or fobs you never gave back when
  you quit.
...
- [Unarmed Training](training/martial-weapon-programs.md#unarmed-training-1-5) Level 1.
- You de-escalate a fight before it starts and read drunk versus dangerous on a passive check. You know the local
  security circuit.
...
- [Envelopment Training](training/tactical-programs.md#envelopment-training-1-4) Level 1.
...
- [Grenade Training](training/tactical-programs.md#grenade-training-1-4) Level 1.
...
- [Covert Movement Training](training/covert-programs.md#covert-movement-training-1-3) Level 1.
- Trained on badge-cloning, tailgating, and common corporate network weaknesses. You are comfortable on both sides of
  the keyboard and the door.
...
- [Ambush Training](training/covert-programs.md#ambush-training-1-4) Level 1.
...
- [Evasion Training](training/tactical-programs.md#evasion-training-1-5) Level 1.
...
- [Language Training](training/mental-fitness-programs.md#language-training-1-5) Level 1 (a language of your choice).
- You read social registers others miss - host-country manners, expatriate cliques, and class markers in three
  countries.
...
- [Education Training](training/mental-fitness-programs.md#education-training-1-4) Level 1.
- You stabilize wounded animals and diagnose livestock or pets without a check. You are credible at rural farms and
  with animal-rescue NGOs.
...
- [Resolve Training](training/mental-fitness-programs.md#resolve-training-1-4) Level 1.
- You know the logistics of flight - papers, trains, borders, and who to avoid. One contact in an émigré community of
  your choice.
...
- [Mental Skills Training](training/mental-fitness-programs.md#mental-skills-training-1-5) Level 1 (Animal Handling).
- You are comfortable with large or dangerous wildlife and are trained on tranquilizer dosing and containment
  procedure.
