...
Holdout-, Backup- und Service-Pistolen sowie Revolver. Siehe [Weapon Properties](../rules/weapon-properties.md) für die
Property-Schlüsselwörter.

## Holdout Pistols {#holdout-pistols}

| Name                        | Kaliber      | Schaden | Misfire/Crit | Reichweite | Gewicht | Eigenschaften                                                                         | Req |
|-----------------------------|--------------|---------|--------------|------------|---------|---------------------------------------------------------------------------------------|-----|
...
## Service Pistols {#service-pistols}
...
## Backup Revolvers {#backup-revolvers}
...
## Service Revolvers {#service-revolvers}
...
## Hunting Revolvers {#hunting-revolvers}
