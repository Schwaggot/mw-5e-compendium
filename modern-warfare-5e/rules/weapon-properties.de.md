...
**Deviation (-):** Nominiere einen Punkt innerhalb der Reichweite. Würfle einen Angriff vs AC 10 (+5 pro Reichweitenschritt jenseits des ersten). Bei einem
Fehlschlag würfle den Streu-Würfel und einen Abweichungs-Würfel (ziehe DEX-Bonus ab, Min 1); Ergebnis = 5 ft Schritte abgewichen in Streu-
...
**Reloading:** Gib eine Action oder einen Angriff aus, um nachzuladen, wenn leer.

**Recoil (-):** Wenn Strength geringer als der Recoil-Wert ist, -1 auf Single-Shot Angriffswürfe; für Burst/Auto ist die Angriffs-
strafe = Recoil - Strength.

**Critical Success/Failure:** Natürliche Würfe auf oder unter dem Critical-Failure-Bereich sind automatische Fehlschläge; natürliche Würfe auf oder über
...
**Blast (-ft):** Kreaturen innerhalb des Radius machen einen DEX Save DC 8 + Proficiency + DEX Mod (falls Proficient). Fehlschlag = voller
...
**Lite:** Kompakt, leichtgewichtig und leicht verdeckt zu tragen. Erlaubt Off-Hand-Bonus-Action-Angriffe ohne Dual-Wielding-
Training und gewährt Advantage auf Sleight of Hand zum schnellen Ziehen. (Unterscheidet sich von der "Light" Rüstungs-Gewichtsklasse.)
...
**Select Fire (S/B/A):** Die Waffe bietet mehr als einen Feuermodus - beliebige Kombination aus Single-Shot, Burst und Auto.
