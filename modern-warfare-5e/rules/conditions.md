...
Stress damage condition with 5 levels.
...
A creature suffers all effects up to its current level. Stress damage heals over rest.
See [Damage Types](damage-types.md#stress-damage).
