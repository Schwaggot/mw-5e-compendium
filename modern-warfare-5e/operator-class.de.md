...
| Level | Proficiency Bonus | Merkmale                                          |
|-------|-------------------|---------------------------------------------------|
...
## Klassenmerkmale {#class-features}

Als Operator hast du die folgenden Ausbildungsprogramme abgeschlossen und erhalten.

### Hit Points {#hit-points}

- **Hit Dice:** 1d10 pro Operator-Level
- **Hit Points auf Level 1:** 10 + dein Constitution-Wert (nicht CON-Bonus)
- **Hit Points auf höheren Leveln:** 1d10 (oder 6) + dein Constitution-Modifikator pro Operator-Level nach dem 1.

### Starter-Ausbildungsprogramme {#starter-training-programs}

- **Armor Training:** Armor Training Level 1 in Light und Medium.
...
- **Two-Weapon Fighting:** Wenn du mit zwei Waffen kämpfst, addiere deinen Attributsmodifikator zum Schaden des zweiten
  Angriffs.
- **Mobility:** +5 ft [Bewegung](rules/movement.md).
- **Strong Throw:** Beim Einsatz einer Wurfwaffe zählt sie immer als 1 Reichweitenvielfaches geringer (Minimum 1).
...
Auf Level 3 wählst du eine Kampfrolle: Rifleman, Marksman, Machine Gunner, Demolitions Specialist, Unit Leader,
Combat Medic, Dog Handler oder Tech Specialist. Die gewählte Kampfrolle gewährt Features auf Level 3, 7, 10, 15 und 18.
Siehe [Kampfrollen](combat-designations.md).
