...
- **Attack Action** - Siehe [Actions](rules/combat-turn.md#actions), [Combat Actions](rules/combat-actions.md).
- **Attributes** - Siehe [Attributes](rules/attributes.md).
- **Automatic Fire** -
...
- **Breaking Contact** - Siehe [Breaking Contact](rules/movement.md#breaking-contact).
- **Burst Fire** - Siehe [Burst Fire](rules/combat-actions.md#burst-fire).
...
- **Combat Turn** - Siehe [Combat Turn](rules/combat-turn.md).
- **Comms** - Siehe [Comms](gear/comms.md).
- **Concealment** -
...
- **CS / Tränengas** - Siehe [Saving Throws](rules/saving-throws.md).
- **Damage Reduction (DR)** - Siehe [Damage Reduction](rules/damage-types.md#damage-reduction).
- **Damage Types** - Siehe [Damage Types](rules/damage-types.md).
- **Dash (Action)** - Siehe [Dash](rules/movement.md#dash).
- **Demolitions (Gear)** - Siehe [Demolitions](gear/demolitions.md).
- **Demolitions Specialist** - Siehe [Demolitions Specialist](designations/demolitions-specialist.md).
- **Designated Marksman Rifle (DMR)** - Siehe [Semi-Auto Rifles](weapons/semi-auto-rifles.md).
- **Dexterity (DEX)** - Siehe [Attributes](rules/attributes.md#the-six-attributes).
- **Difficulty Class (DC)** -
  Siehe [Ability Checks](rules/ability-checks.md), [Saving Throws](rules/saving-throws.md#save-dc-of-effects-you-impose).
- **Disadvantage** - Siehe [Advantage](rules/advantage.md).
- **Disengage** - Siehe [Disengage](rules/movement.md#disengage).
- **Dog Handler** - Siehe [Dog Handler](designations/dog-handler.md).
- **Drohnen** - Siehe [Drones](gear/drones.md).
- **Elektronik** - Siehe [Electronics](gear/electronics.md).
- **Encumbrance** - Siehe [Encumbrance](rules/encumbrance.md).
- **Erschöpfung** - Siehe [Exhaustion](rules/conditions.md#exhaustion).
- **Expertise** - Siehe [Expertise](rules/proficiency.md#expertise).
- **Extra Attack** - Siehe [Extra Attack](operator-class.md#extra-attack).
- **Field Kit** - Siehe [Field Kit](gear/field-kit.md).
- **Firing Modes** -
  Siehe [Automatic Firing Modes](rules/combat-actions.md#automatic-firing-modes), [Weapon Properties](rules/weapon-properties.md).
...
- **Operator Class** - Siehe [Operator Class](operator-class.md).
- **Opportunity Attack** -
  Siehe [Ranged Opportunity Attack](rules/combat-actions.md#ranged-opportunity-attack), [Combat Actions](rules/combat-actions.md).
- **Optics** - Siehe [Optics](gear/optics.md).
- **Packs** - Siehe [Packs](gear/packs.md).
- **Passive Checks** - Siehe [Passive Checks](rules/ability-checks.md#passive-checks).
- **Personality Traits** - Siehe [Personality Traits](personality-traits.md).
...
- **Training Programs** - Siehe [Training Programs](training-programs.md).
- **Triage Code** - Siehe [Triage Code](rules/hit-points.md#triage-code).
